...
Befehle für Übung am 29.01.2020
...
```
Die Datei `createGlobalPtclFromASC.py` muss nun so angepasst werden, dass für die Variable `start_meas_tscan_rostime` (etwa Zeile 60) die Roszeit (Unixtime, z.B. 1579272653.208600) gewählt wird, die für das einzuspielende bagfile gilt. Zusätzlich müssen die Variable Dateiname.asc, time_delta und parent_frame passend gesetzt werden. Anschließend kann das python program ausgeführt werden.
